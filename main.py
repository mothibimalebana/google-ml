...
reduced_X_train = X_train.drop(cols_with_missing_value, axis=1)                                         
reduced_X_train = reduced_X_train.select_dtypes(exclude=["object", "str"])


reduced_X_test = X_test.drop(cols_with_missing_value, axis=1)                                         
reduced_X_test = reduced_X_test.select_dtypes(exclude=["object", "str"])
...
print("drop columns: ", score_dataset(reduced_X_train, reduced_X_test, y_test, y_train))